...
def auto():	
	...
	if __name__ == '__main__':
		...
		#ser.reset_input_buffer()
		ser.write("ncclk,400".encode("utf-8"))
		sleep(5);
		for i in range(21):
			image=np.empty((240*320*3),dtype=np.uint8)
			camera.capture(image,'bgr')
			image=image.reshape((240,320,3))
			camera.capture("/home/pi/Downloads/40x/image{0}({1}).jpg".format(i,variance(image)))
		...
		l=np.argmax(var)
		sleep(2)
		a="zclk,{}".format(400-l*20)
		ser.write(a.encode("utf-8"))
		camera.resolution=(1920,1088)
		sleep(8)
		camera.capture("/home/pi/Downloads/40x/focusedimage.jpg")
		sleep(2)
		ser.write("nclk,410".encode("utf-8"))
